...
public class StatoPatrimonialeRepositoryTest {
    ...
    public void testUpdate(){
        Long id = 625L;//necessario osservare l'id dal DB perche' generato automaticamente al momento dell'inserimento
    ...
    @Order(3)
    public void testGet(){
        Long id = 624L;//necessario osservare l'id dal DB perche' generato automaticamente al momento dell'inserimento

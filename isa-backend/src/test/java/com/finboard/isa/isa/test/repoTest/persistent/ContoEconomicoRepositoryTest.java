...
public class ContoEconomicoRepositoryTest {
    ...
    public void testUpdate(){
        Long id = 669L;//necessario osservare l'id dal DB perche' generato automaticamente al momento dell'inserimento
    ...
    @Order(3)
    public void testGet(){
        Long id = 672L;//necessario osservare l'id dal DB perche' generato automaticamente al momento dell'inserimento

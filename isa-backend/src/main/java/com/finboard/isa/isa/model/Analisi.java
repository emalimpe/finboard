...
public class Analisi {
    ...
    /**
     *params StatoPatrimoniale sp, ContoEconomico ce
     *return class Analisi instance*/
     ...
     *params Date
     *return void */
    private void setStilatura(Date stilatura) {
        this.stilatura = stilatura;
    }


    /**
     * set the Stato Patrimoniale field
     *
     *params StatoPatrimoniale
     *return void */
    ...
    /**
     * set the Conto Economico field
     *
     *params ContoEconomico
     *return void */
    ...
    // calculates the indexes which compose the struttura field
    private void setStruttura(){
    ...
    //calculates the indexes which compose the solidita field
     private void setSolidita(){
    ...
    //calculates the indexes which compose the tesoreria field
    private void setTesoreria(){
    ...
    //calculates the indexes which compose the rigidita e rotazioni field
    private void setRaR(){
     ...
     * mapped with a key value
     *params null
     *return HashMap[String,HashMap[String,Float]]*/
